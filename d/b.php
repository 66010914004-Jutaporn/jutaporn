...
<body>
<h1>ฟอร์มรับข้อมูล 66010914004 จุฑาภรณ์ สมจันทร์(ฝน)</h1>
...
<br><br>    
<!--<input type="subimt"name"Submit" value="สมัครสมาชิก">-->
...
<button type="button"  onMouseOver="alert('จ๊ะโอ๋!');">Hello</button>
